    ...
    items: [
      {
        ...
        inclusions: [
          { label: "1x RC Pro Controller", cost: 0 },
          { label: "1x Hard Carrying Case", cost: 0 },
          { label: "3x Intelligent Batteries", cost: 0 },
          { label: "1x Speaker & Spotlight Combo", cost: 0 },
          {
            label: "Training Conducted by CAAP Certified Drone Instructor (2 Pax)",
            cost: 0,
          },
        ],
      ...
      },
      {
        ...
        inclusions: [
          { label: "2x V-Mount Battery Plates", cost: 0 },
          { label: "1x DC 12V Cable Connector", cost: 0 },
          { label: "1x XLR Connector", cost: 0 },
        ],
        warranty: "at least 1 Year Warranty",
        qty: 1,
        unit: "unit",
